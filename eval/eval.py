...
def producer_fn(proc_id, k_res, args, taskvar, pred_file, batch_queue, result_queue, producer_queue):
    task_str, variation = taskvar.split('+')#带peract的
    ...
    for demo_id in range(num_demos):
        ...
        for step_id in range(args.max_steps):
            ...
            except (IKError, ConfigurationPathError, InvalidActionError) as e: #不合法的动作
...
def main():
    ...
    args.exp_config = os.path.join(args.expr_dir, 'logs', 'training_config.yaml') #/home/mike/many_work/mini-diffuse-actor/experiments
